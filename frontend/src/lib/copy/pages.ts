...
export const PAGE_META: Record<PageId, PageMeta> = {
  ...
  reservations: { title: "Reservations", subtitle: "Chaque service sous controle." },
  ...
  stocks: { title: "Mon stock", subtitle: "Tes produits, tes seuils, tes alertes." },
  commandes: { title: "Commandes", subtitle: "Commande, receptionne, c'est trace." },
}
