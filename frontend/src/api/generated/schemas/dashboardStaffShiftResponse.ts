 ...
 */
import type { DashboardEmployeeShift } from "./dashboardEmployeeShift"
import type { DashboardPeriod } from "./dashboardPeriod"
import type { DashboardStaffShiftSummary } from "./dashboardStaffShiftSummary"

export interface DashboardStaffShiftResponse {
  restaurant_id: number
  restaurant_name: string
  date: string
  period: DashboardPeriod
  summary: DashboardStaffShiftSummary
  employees: DashboardEmployeeShift[]
}
