...
import type { LignesEnvoyerCuisineResponsePrintStatus } from "./lignesEnvoyerCuisineResponsePrintStatus"

export interface LignesEnvoyerCuisineResponse {
  lines: LigneCommande[]
  print_status: LignesEnvoyerCuisineResponsePrintStatus
}
