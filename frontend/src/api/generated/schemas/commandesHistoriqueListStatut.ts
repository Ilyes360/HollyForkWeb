...
export type CommandesHistoriqueListStatut =
  (typeof CommandesHistoriqueListStatut)[keyof typeof CommandesHistoriqueListStatut]

export const CommandesHistoriqueListStatut = {
  ANNULEE: "ANNULEE",
  EN_COURS: "EN_COURS",
  VALIDEE: "VALIDEE",
} as const
