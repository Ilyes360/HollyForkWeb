...
export type ImprimantesReseauListCategorie =
  (typeof ImprimantesReseauListCategorie)[keyof typeof ImprimantesReseauListCategorie]

export const ImprimantesReseauListCategorie = {
  BUREAU: "BUREAU",
  CAISSE: "CAISSE",
  CUISINE: "CUISINE",
  SALLE: "SALLE",
